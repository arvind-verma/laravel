...
<html lang="en">
    <head>
        ...
        <!-- Vendor styles -->
        <link rel="stylesheet" href="{{url('/')}}/document/vendors/material-design-iconic-font/css/material-design-iconic-font.min.css">
        <link rel="stylesheet" href="{{url('/')}}/document/vendors/animate.css/animate.min.css">
        <link rel="stylesheet" href="{{url('/')}}/document/vendors/jquery-scrollbar/jquery.scrollbar.css">
        <link rel="stylesheet" href="{{url('/')}}/document/vendors/fullcalendar/fullcalendar.min.css">

        <!-- App styles -->
        <link rel="stylesheet" href="{{url('/')}}/document/css/app.min.css">
    </head>
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                            <div class="listview listview--hover">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{url('/')}}/document/demo/img/profile-pics/1.jpg" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{url('/')}}/document/demo/img/profile-pics/2.jpg" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{url('/')}}/document/demo/img/profile-pics/3.jpg" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{url('/')}}/document/demo/img/profile-pics/4.jpg" class="listview__img" alt="">
                                ...
                                <a href="" class="listview__item">
                                    <img src="{{url('/')}}/document/demo/img/profile-pics/5.jpg" class="listview__img" alt="">
