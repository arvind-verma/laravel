                ...
                <div class="scrollbar-inner">
                    <div class="user">
                        <div class="user__info" data-toggle="dropdown">
                            <img class="user__img" src="{{url('/')}}/document/demo/img/profile-pics/8.jpg" alt="">
                            <div>
								...
								print($user->name);
								?></div>
                                <div class="user__email"><?php print($user->email);?></div>
                            </div>
                        </div>

                        <div class="dropdown-menu"> 
                            <a class="dropdown-item" href="{{ url('/resetpassword/') }}">Reset Password</a>
                            <a class="dropdown-item" href="{{ url('/profileReset/')  }}">Change Profile Settings</a>
