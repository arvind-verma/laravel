...
@include('include.sidebar')
            ...
            <section class="content">
                ...
                <div data-columns>
                    <div class="card">
                        <img class="card-img-top" src="{{url('/')}}/document/demo/img/widgets/note.png" alt="">
                        <div class="card-body">
                        ...
                        <div class="listview listview--striped">
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{url('/')}}/document/demo/img/flags/United_States_of_America.png" alt=""> United States</span>
                                        <span>Firefox</span>
                                        <span>Mac OSX</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{url('/')}}/document/demo/img/flags/Australia.png" alt=""> Australia</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{url('/')}}/document/demo/img/flags/Brazil.png" alt=""> Brazil</span>
                                        <span>Edge</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{url('/')}}/document/demo/img/flags/South_Korea.png" alt=""> South Korea</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{url('/')}}/document/demo/img/flags/Japan.png" alt=""> Japan</span>
                                        <span>Chrome</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
        ...
        <script src="{{url('/')}}/document/vendors/flot/jquery.flot.js"></script>
        <script src="{{url('/')}}/document/vendors/flot/jquery.flot.resize.js"></script>
        <script src="{{url('/')}}/document/vendors/flot.curvedlines/curvedLines.js"></script>
        <script src="{{url('/')}}/document/vendors/jqvmap/jquery.vmap.min.js"></script>
        <script src="{{url('/')}}/document/vendors/jqvmap/maps/jquery.vmap.world.js"></script>
        <script src="{{url('/')}}/document/vendors/easy-pie-chart/jquery.easypiechart.min.js"></script>
        <script src="{{url('/')}}/document/vendors/salvattore/salvattore.min.js"></script>
        <script src="{{url('/')}}/document/vendors/sparkline/jquery.sparkline.min.js"></script>
        <script src="{{url('/')}}/document/vendors/moment/moment.min.js"></script>
        <script src="{{url('/')}}/document/vendors/fullcalendar/fullcalendar.min.js"></script>

        <!-- Charts and maps-->
        <script src="{{url('/')}}/document/demo/js/flot-charts/curved-line.js"></script>
        <script src="{{url('/')}}/document/demo/js/flot-charts/dynamic.js"></script>
        <script src="{{url('/')}}/document/demo/js/flot-charts/line.js"></script>
        <script src="{{url('/')}}/document/demo/js/flot-charts/chart-tooltips.js"></script>
        <script src="{{url('/')}}/document/demo/js/other-charts.js"></script>
        <script src="{{url('/')}}/document/demo/js/jqvmap.js"></script>
