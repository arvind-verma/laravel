                        ...
                        <div class="form-group row">
						 ...
						 <div class="form-group row">
                            ...
                            <div class="col-md-6">
								...
								<input type="radio" id="s20" name="status" value="1" /><label for="s20" title="5">Doctor</label>
								<input type="radio" id="s19" name="status" value="0" / checked><label for="s19" title="4">User</label>
